...
const steps = [
  {
    ...
    description:
      "Погружаемся в текущие процессы, инструменты и данные. Совместно определяем, где ИИ может безопасно забрать рутину.",
    meta: "1–2 стратегические сессии"
  },
  {
    title: "Проектируем и строим ИИ‑автоматизацию",
    description:
      "Проектируем и реализуем ИИ‑ассистентов, промпты и интеграции с вашей CRM, ERP, мессенджерами и внутренними системами.",
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-md">
            ...
            <p className="mt-4 text-balance text-2xl font-semibold tracking-tight text-slate-50 sm:text-3xl">
              От идеи до работающего ИИ‑сотрудника за три понятных шага.
            </p>
