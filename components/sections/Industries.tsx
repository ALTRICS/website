  ...
  return (
    <Section id="industries" alt>
      <SectionHeader
        ...
        description="Ядро решения остаётся единым: заявки, клиенты, диалоги, AI-боты, база знаний и аналитика. Под каждую сферу меняются сценарии, статусы, поля заявки, инструкции AI и интеграции."
      />
