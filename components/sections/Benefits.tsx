...
const benefits = [
  {
    ...
    description:
      "ИИ‑сотрудники берут на себя однообразные задачи: ответы на типовые вопросы, заполнение CRM, подготовку документов и отчётов."
  },
  {
    title: "Снижение операционных затрат",
    description:
      "Вместо увеличения штата вы масштабируете операции за счёт ИИ‑ассистентов, которые работают 24/7."
  },
  {
  ...
  },
  {
    ...
    description:
      "Когда увеличивается объём заказов, ИИ просто обрабатывает больше задач параллельно, а команда сосредотачивается на стратегии."
  }
];
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-md">
            ...
            <p className="mt-4 text-balance text-2xl font-semibold tracking-tight text-slate-50 sm:text-3xl">
              Осязаемые бизнес‑результаты, а не очередная ИИ-игрушка.
            </p>
