      ...
      <div className="relative overflow-hidden rounded-3xl border border-primary/10 bg-gradient-to-br from-indigo-50 via-white to-sky-50 px-6 py-12 text-center shadow-soft sm:px-12 sm:py-14 lg:text-left">
        ...
        <div className="relative max-w-2xl">
          <h2 className="text-balance text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
            Обсудим, как встроить ИИ в работу вашей команды
          </h2>
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            Расскажите, как сейчас поступают заявки, где менеджеры теряют время
            и какие ответы повторяются чаще всего. Мы предложим первый сценарий,
            подходящий формат работы и план запуска.
          </p>
        </div>
